...
with st.expander("📖 補足事項はこちら"):
    st.markdown("""
### データの出典：
- 芳文社様『まんがタイムきらら』公式サイト　まんがタイムきららWeb  
### 更新タイミング：
...
②1号につき巻頭カラーが1作品であり、その作品が掲載順1番であること。  
    ただし、きらら2016-5月号は巻頭カラーの『三者三葉』が掲載順2番ですが実態不明です。  
③本誌、MAX、ミラク、キャラットでは1号につき4作品のセンターカラーがあること 
プログラムでセンターカラーの抽出がしきれていない場合は下記の見方で一覧の手入力をしています。  
(1)ホームページの本文内にカラーの記載がないか。  
(2)前月号のページに次回カラーの予告がないか。  
(3)対象号のまんがタイムきらら公式ツイッターでカラーの記載がないか。  
上記でも確認できないものは不明としています。 
  下記の号についてはセンターカラーの取得が4作未満です。  
- キャラット2013-4,2015-10
- MAX2013-1.2.7.8.2022-11  
